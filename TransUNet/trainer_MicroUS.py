...
def trainer_MicroUS(args, model, snapshot_path):
    from TransUNet.datasets.dataset_MicroUS import MicroUS_dataset, MultiscaleGenerator
    ...
    trainloader = DataLoader(db_train, batch_size=batch_size, shuffle=True, num_workers=0, worker_init_fn=worker_init_fn)
